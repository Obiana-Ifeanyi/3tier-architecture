...
output "user_data_debug" {
  value = aws_launch_template.web_server_launch_template.user_data
}
# This output will show you the encoded user data generated by Terraform during the apply, and you can inspect it to ensure it looks correct.